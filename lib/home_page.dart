                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: (BannerList.length==0)?Container(padding: EdgeInsets.all(2),width: 20,child: (globVar.isLoading??false)?LinearProgressIndicator(backgroundColor: Colors.grey,valueColor: new AlwaysStoppedAnimation<Color>(Colors.white),
                                      ):null):ListView.builder(shrinkWrap: true,scrollDirection: Axis.horizontal,itemCount: BannerList.length,itemBuilder: (context,index)=>Padding(
