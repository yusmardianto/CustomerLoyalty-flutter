...
class NewsBanner{
  ...
  NewsBanner.fromJson(Map<String, dynamic> json){
    ...
    this.message_image = (json[jsonKeys[4]]!=null)?Base64Decoder().convert(json[jsonKeys[4]]):null;
    this.date = (json[jsonKeys[5]]!=null)?DateTime.parse(json[jsonKeys[5]]).toLocal():null;
  }
